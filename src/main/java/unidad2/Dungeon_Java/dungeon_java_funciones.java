package unidad2.Dungeon_Java;
import unidad2.boletin1_java.ejercicio10;

import java.util.Random;
import java.util.Scanner;

public class dungeon_java_funciones {
    public int ataque_basico(int hp_monstruo){
    ...
    static void main(String[] args) {
        ...
        dungeon_java_funciones referecncia = new  dungeon_java_funciones();
        ...
        while (hp_heroe > 0 && hp_monstruo > 0){
            ...
            switch (eleccion){
                case 1:
                   hp_monstruo =  referecncia.ataque_basico(hp_monstruo);
                    break;
                case 2:
                    if (mp >= 5){
